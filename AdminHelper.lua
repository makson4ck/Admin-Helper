...
forms = {
    ...
    formnick = imgui.new.char[256]("Error, не найдено"),
    formtext = imgui.new.char[256]("Error, не найдено.."),
...
local accessesForms = {
    ['mute'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['mute']), access = 2},
    ['rmute'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['rmute']), access = 2},
    ['unmute'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['unmute']), access = 2},
    ['unrmute'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['unrmute']), access = 2},
    ['jail'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['jail']), access = 2},
    ['unjail'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['unjail']), access = 2},
    ['apunish'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['apunish']), access = 3},
    ['bail'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['bail']), access = 3},
    ['warn'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['warn']), access = 3},
    ['unwarn'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['unwarn']), access = 3},
    ['ban'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['ban']), access = 3},
    ['slap'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['slap']), access = 3},
    ['sethp'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['sethp']), access = 1},
    ['pm'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['pm']), access = 1},
    ['spplayer'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['spplayer']), access = 1},
    ['spcar'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['spcar']), access = 1},
    ['flip'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['flip']), access = 1},
    ['weap'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['weap']), access = 2},
    ['cure'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['cure']), access = 2},
    ['adeldesc'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['adeldesc']), access = 2},
    ['plveh'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['plveh']), access = 3},
    ['givegun'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['givegun']), access = 3},
    ['accepttrade'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['accepttrade']), access = 3},
    ['removetune'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['removetune']), access = 3},
    ['getip'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['getip']), access = 3},
    ['setfuel'] = {requiredTag = imgui.new.bool(false), typeAccept = imgui.new.int(jsonsettings['forms']['list']['setfuel'] or 0), access = 3},
    ['gunban'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['gunban'] or 0), access = 3},
    ['banip'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['banip'] or 0), access = 4},
    ['unban'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['unban'] or 0), access = 4},
    ['sbanip'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['sbanip'] or 0), access = 4},
    ['setmember'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['setmember'] or 0), access = 4},
    ['sban'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['sban'] or 0), access = 4},
    ['unbanip'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['unbanip'] or 0), access = 4},
    ['afkkick'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['afkkick'] or 0), access = 4},
    ['uval'] = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['uval'] or 0), access = 4},
    ['warnoff']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['warnoff'] or 0), access = 4},
    ['jailoff']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['jailoff'] or 0), access = 4},
    ['uvaloff']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['uvaloff'] or 0), access = 4},
    ['setvw']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['setvw'] or 0), access = 4},
    ['muteoff']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['muteoff'] or 0), access = 4},
    ['ao']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['ao'] or 0), access = 4},
    ['skick']  = {requiredTag = imgui.new.bool(true), typeAccept = imgui.new.int(jsonsettings['forms']['list']['skick'] or 0), access = 4},
}
local formErrors = {
    ...
    {"^Используй: (.*)","В базе данных такая форма команды не найдена, перепроверьте команду!", false},
    {"^Используй: (.+)","В базе данных такая форма команды не найдена, перепроверьте команду!", false},
    ...
    {"(/warnoff %[name%] %[причина%])", "Используйте: /warnoff [name] [причина]", true},
    {"%[Подсказка%] {ffffff}/setmember (.*)", "Используйте: /setmember [id игрока] [id организации (1-31)] [ранг (1-9)]", true},
    {"Используй: /jail (.*)", "Используйте: /jail [id] [time] [reason]", true},
    {"Используй: /mute (.*)", "Используйте: /mute [id] [time] [reason]", true},
    {"Используй: /warn (.*)", "Используйте: /warn [id] [time] [reason]", true},
    {"Используй: /un(.*)", "Используйте: /команда [id/nick] [reason]", true},
    {"Используй: /uval (.*)", "Используйте: /uval [id]", true},
    {"Используй: /uvaloff (.*)", "Используйте: /uvaloff [Полный ник игрока]", true},
    {"%[Ошибка%] /jailoff (.*)", "Используйте: /jailoff [ник] [время] [причина]", true},
    {"/muteoff %[name%] (.*)", "Используйте: /muteoff [ник] [время] [причина]", true},
    {"Использовать команду можно (.*)", "На сервере меньше 850 игроков!", true},
    {"/slap (.*)", "Используйте: /slap [id] [1 - вверх/ 2 - вниз]", true},
    {"Игрок не (.*)", "Игрок не в деморгане!", true},
    {"У игрока нет варн(.*)", "У игрока нету варнов", true},
    {"/setvw (.*)", "Используйте: /setvw [player id] [world]", true},
    {"Используй: /sbanip (.*)", "Используйте: /sbanip [id] [reason]", true},
    {"Используй: /banip (.*)", "Используйте: /banip [id] [reason]", true},
    {"Используй: /sban (.*)", "Используйте: /sban [id] [time] [reason]", true},
    {"Используй: /pm (.*)", "Используйте: /pm [id] [0 -message/1- dialog] [answer]", true},
    {"Используйте: /ao (.*)", "Используйте: /ao [text]", true},
    {"Игрок с ником (.*)", "Такого игрока нету в базе данных!", true},
    {"Используй: /skick (.*)", "Используйте: /skick [id] ", true},
    {"rezerv", "Используйте: ", true},
...
local pricini = "чит", "реклама"
local reconinfo = {
    status = false,
    reconId = -1
}
local SliderOne = new.int(jsonsettings.settings.transparent_bg)
----====[ MENU ]====----
...
local navigation = {
    ...
    list = {ti.ICON_AD..u8"VIPCHAT", 
        ti.ICON_MESSAGE..u8"ОБЫЧНЫЙ ЧАТ", 
        ti.ICON_ROBOT..u8"АНТИ-БОТ",
        ti.ICON_USER..u8"КАСТОМ-ФОРМЫ",
        ti.ICON_TABLE..u8"ЧЕКЕР ОПИСАНИЙ",
        ti.ICON_TABLE..u8"PLAYERLIST",
        ti.ICON_INFO_SQUARE..u8"О СКРИПТЕ"
    }
}
local notify = {
	game = {
...
notify.game.push = function(text)
	...
	if mention.set.play_sound[0] and SOUND_HANDLE ~= nil then
		setAudioStreamState(SOUND_HANDLE, 1)
	end
end
...
local nazvaniemp = imgui.new.char[256](u8'Название и приз')
...
local yspex = u8"log: Ещё ничего не изменялось"
...
function main()
    ...
    sampAddChatMessage('[Admin Helper] {ffffff}Хелпер успешно загружен!',  0x4169E1)
        ...
        if jsonsettings.settings.logreg then
                if #regs > jsonsettings.settings.pagesize then
                    ...
                    local O = 17
                        cX = jsonsettings.settings.posX
                        cY = jsonsettings.settings.posY
                    renderFontDrawTextAlign(font, 'Ник_Нейм[Ид] | Город - Провайдер', cX, cY - 20,  0xFF00FF00, font_set['align'][0])
	...
	sampRegisterChatCommand("plfix", function()
		check = false
		sampAddChatMessage("{4682B4}[PList]{ffffff} Фикс! Проверяйте!.", -1) 
	end)
	if name == nil then
...
function sampev.onShowDialog(dialogId, style, title, button1, button2, text)
    if text:find("Описание игрока") then
        local nick, id = text:match("Описание игрока {ffff00}(.+)%[ID%: (%d+)%]")
    ...
    if check then
		if text:find("Надетые аксессуары%:") then
			if text:find("+1") or text:find("+2") or text:find("+3") or text:find("+4") or text:find("+5") or text:find("+6") or text:find("+7") or text:find("+8") or text:find("+9") or text:find("+10") or text:find("+11") or text:find("+12") then
				lua_thread.create(function()
					wait(100)
					if nick ~= name then
					sampAddChatMessage("{4682B4}[PList]{ffffff} Подозрение на АКСЫ от {FF0000}"..nick.."["..id.."]", -1)
					caks = caks + 1
					end
				end)
			end
		...
		if text:find("Надетые улучшения оружия%:")  then
			if not text:find("Пусто") or text:find("Компенсатор") or text:find("Приклад") or text:find("Цевьё") or text:find("+") then
				lua_thread.create(function()
					wait(500)
					if nick ~= name then
						sampAddChatMessage("{4682B4}[PList]{ffffff} Подозрение на ОБВЕСЫ от {FF0000}"..nick.."["..id.."]", -1)
						cobv = cobv + 1
					end
				end)
			end
...
function sampev.onServerMessage(color, text)
    ...
    if text:find('Игрок не в сети') then
     ...
     if text:find('На этом игроке нет описания') then
        return false
     end
    ...
    if check then
		if text:find("Информация о игроке") then
			nick, id = text:match("Информация о игроке (.+)%[(%d+)%]")
			return false
		end
    if text:find('%[(.+)%] (.+) | Уровень: (.+) | UID: (.+) | packetloss: (.+).(.+) (.+)') then
            local nill1, nickname, ur, uid, packetlos, pack2, launch = text:match('%[(.+)%] (.+) | Уровень: (.+) | UID: (.+) | packetloss: (.+).(.+) (.+)')
            ...
            local packetlosik = ""
            if pack[0] > 10 then
                packetlosik = ("{4682B4}[Admin Helper]{ffffff} Подозрение на ПАКЕТЛОС от {FF0000}"..nickname.."["..nill1.."] packetlos: "..packetlos)
    ...
    if bSettings.forms.activeform[0] then
        if text:find('%[A%] '..bSettings.forms.formnick2..'%[(.+)%]: %+') or text:find('%[A%] '..bSettings.forms.formnick2..'%[(.+)%]: да') then
            sampAddChatMessage('{10f200}Отправитель формы: {ff0303}'..bSettings.forms.formnick2..' {10f200}подтвердил выдачу наказания! Скорей же наказывай!', -1)
            bSettings.forms.formplus = true
        end
    end
    if bSettings.forms.activeform[0] then 
    if text:find('%[A%] '..bSettings.forms.formnick2..'%[(.+)%]: %-') or text:find('%[A%] '..bSettings.forms.formnick2..'%[(.+)%]: нет') then
            sampAddChatMessage('{ff0303} Отправитель формы: '..bSettings.forms.formnick2..' не подтвердил выдачу наказания! НЕ наказывай!', -1)
    ...
    if on_chat[0] == true then
        if text:find("(%w+_%w+)%[(%d+)%] говорит:%{......%} (.+)") then
            local playernick, playerid, content = text:match("(%w+_%w+)%[(%d+)%] говорит:%{......%} (.+)")
            table.insert(ChatTable, 1, {playernick, playerid, ":"..content, os.time()})
        end
        if text:find("(%w+_%w+)%[(%d+)%] кричит: (.+)") then
            local playernick, playerid, content = text:match("(%w+_%w+)%[(%d+)%] кричит: (.+)")
            table.insert(ChatTable, 1, {playernick, playerid, "{f1ff96}кричит:"..content, os.time()})
        end
    end
    if on_adminnrp[0] then
        if text:find("%(%( Администратор (.+)%[(.+)%]: {B7AFAF}(.+){FFFFFF} %)%)") then
            local playernick, playerid, content = text:match('%(%( Администратор (.+)%[(.+)%]: {B7AFAF}(.+){FFFFFF} %)%)')
    ...
    if text:find("%[Ошибка%] %{FFFFFF%}Наблюдается попытка взлома!") then
            accept = false
    end
    if text:find("Вы подтвердили права на админа") then
            accept = true
    end
    local r, g, b, a = explode_argb(color)
	if bSettings.settings.banoff then
            if text:find('A: '..jsonsettings.nick..'%[(.+)%](.+)забанил игрока (.+)%[(.+)%]. Причина: '..pricini) then
                local id, proverka, nick2, id2, pric = text:match('A: '..jsonsettings.nick..'%[(.+)%](.+)забанил игрока (.+)%[(.+)%]. Причина: (.+)')
                addbanoff(nick2, pric)
            end
            if text:find('A: '..jsonsettings.nick..'%[(.+)%](.+)забанил игрока (.+)%[(.+)%]. Причина: '..pricini..' // '..tag) then
                local id, proverka, nick2, id2, pric = text:match('A: '..jsonsettings.nick..'%[(.+)%](.+)забанил игрока (.+)%[(.+)%]. Причина: (.+) // '..tag)
                addbanoff(nick2, pric)
            end
	end
	if (text:find("с%: %d+%.%d+%.%d+%.%d+") or text:find("%На IP: %d+%.%d+%.%d+%.%d+ - - - -")) and abot[0] then
		ips = text:match("%: (%d+%.%d+%.%d+%.%d+)")
		strana, gor, provaid = "wait", "wait", "wait"
		asyncHttpRequest('GET', "http://ip-api.com/json/"..ips.."?fields=status,country,city,as,query&lang=ru", nil --[[Аргументы запроса]],
			function(response)
				...
				for k, v in pairs(jsonsettings.bots) do
					if v == provaid then
						provaid = "(В ЧСЕ!!!)"..provaid..""
					end
				end
                if strana == "Канада" then
                    sampSendChat('/sbanip '..name..' чит')
                end
			end,
			function(err)
	...
	if (text:find("с%: %d+%.%d+%.%d+%.%d+") or text:find("%На IP: %d+%.%d+%.%d+%.%d+")) and adbotcfg then
				ipp = text:match("%: (%d+%.%d+%.%d+%.%d+)")
				asyncHttpRequest('GET', "http://ip-api.com/json/"..ipp.."?fields=status,country,city,as,query&lang=ru", nil --[[Аргументы запроса]],
			function(response)
				local rdata = cjson.decode(u8:decode(response.text))
				prov = rdata["as"]
				for k, v in pairs(jsonsettings.bots) do
					if v == prov then
					  adbotcfg = false
					  sampAddChatMessage('[AntiBot]{ffffff} Провайдер: {4169E1}'..prov.."{ffffff} уже есть в базе ботов!", 0x4169E1)
					end
				  end
				if adbotcfg then
				table.insert(jsonsettings.bots, prov)
                save()
					sampAddChatMessage('[AntiBot]{ffffff} Провайдер: {4169E1}'..prov.."{ffffff} сохранен!", 0x4169E1)
		end
		 end,
		 function(err)
			sampAddChatMessage('[AntiBot]{ffffff} Ошибка получения ip', 0x4169E1)
		 end)
    end
	if bSettings.settings.checkbot then
		if text:find("Приветствуем нового игрока нашего сервера%: %{......%}(.+) %{FFFFFF%}%(ID%: (%d+)%)") then
			if text:find("IP%: %d+%.%d+%.%d+%.%d+") then
				chipbot(text)
				return false
			else
				sampAddChatMessage('[AntiBot] {ffffff}У вас выключена система показа ip. Включите ее в /apanel', 0x4169E1)
				jsonsettings.settings.checkbot = false
				jsonsettings.settings.logreg = false
				save()
					sampAddChatMessage('[AntiBot]{ffffff} Проверка регистраций на ip и логирование регистраций отключены!', 0x4169E1)
			end
		end
	end
...
for i, v in pairs(formErrors) do
    if text:find(v[1]) and bSettings.forms.isFormFindError[0] then
        bSettings.forms.isError[0] = true
        imgui.StrCopy(bSettings.forms.errortext, v[2])
    end
end
end
...
local function delay32()
  lua_thread.create(function()
                            ...
                            bSettings.progrestext = "{00ffd5}Проверка начата!"
                        for i = 1, 20 do
                            bSettings.progresproc = i
                            wait(40)
                        end
                        bSettings.progrestext = "{44ff3d}Выполняю запрос на сайт.."
                        for i = 20, 40 do
                            bSettings.progresproc = i
                            wait(40)
                        end
                        ...
                        if response.status_code == 200 then
                            bSettings.progrestext = "{09ff00}Запрос выполнен.."
                            for i = 40, 60 do
                                bSettings.progresproc = i
                                wait(40)
                            end
                            ...
                            if versionInfo['version'] ~= bSettings.update.version then
                                bSettings.progrestext = "{ffa200}Обрабатываем ответ сайта.."
                                for i = 60, 80 do
                                    bSettings.progresproc = i
                                    wait(20)
                                end
                                ...
                                bSettings.update.updateText = "{11ff00}Найдено обновление на версию {ffffff}"..u8(versionInfo['version']).."\n"..u8:decode(versionInfo['description'])
                                wait(500)
                                bar = false
                            else
                                bSettings.progrestext = "{09ff00}Запрос выполнен.."
                                ...
                                bSettings.progrestext = "{ffa200}Обработка ответа сайта.."
                                for i = 80, 100 do
                                    bSettings.progresproc = i
                                    wait(20)
                                end
                                bSettings.update.updateText = "{ff1100}Обновлений не найдено"
                                bar = false
                            end
                        else
                            sampAddChatMessage("Ошибка "..response.status_code,-1)
                            bar = false
                        end
  end)
end
local function delay34()
  local response = requests.get("https://raw.githubusercontent.com/makson4ck/Admin-Helper/main/AdminHelper.luac")

                        if response.status_code == 200 then

                            local filepath = script.this.path
                            if isMonetLoader() then
                            sampAddChatMessage('{4682B4}[Admin Helper] {ffffff}Успешное обновление!', -1)
                            sampAddChatMessage('{4682B4}[Admin Helper] {ffffff}Может залагать, просто подождите и оно обновится и выдас сообщение о запуске скрипта', -1)
                            os.remove(filepath)
                            local f = assert(io.open('AdminHelper.luac', 'wb'))
                            f:write(response.text)
                            f:close()
                            script.this:reload()
                    else
                        os.remove(filepath)
                        downloadUrlToFile("https://raw.githubusercontent.com/makson4ck/Admin-Helper/main/AdminHelper.luac", filepath,  function(id, status)
                        end)
                        sampAddChatMessage('{4682B4}[Admin Helper] {ffffff}Успешное обновление!', -1)
                        sampAddChatMessage('{4682B4}[Admin Helper] {ffffff}Может залагать, просто подождите и оно обновится и выдас сообщение о запуске скрипта', -1)
                    end
...
local function delay35()
  lua_thread.create(function ()
                        ...
                        sampAddChatMessage('Нажмите {32CD32}ЛКМ{FFFFFF} что-бы сохранить позицию', -1)
...
local function delay36()
  if imgui.Combo(u8'Тема‹', selected_theme, items, #theme_a) then
            ...
            imgui.Text(u8' - Цвет оформления менюшек')
            end
local function delay33()
  lua_thread.create(function()

                        yspex = (u8'log: Чтение, перезапись базы данных')
                        ...
                        save()
                        yspex = (u8("Провайдер "..adprov.." сохранен!"))
                        abotcfg = false
                        else
                            yspex = (u8"log: Такой провайдер уже есть в базе ботов!")
                            abotcfg = false
                        end
  end)
                  end
...
imgui.OnFrame(function() return WinState[0] end, function(player)
        ...
        if imgui.BeginChild("#Menu", imgui.ImVec2(-1, -1), true) then
            if navigation.current == 1 then -- вип
                if imgui.ToggleButton(u8 " Включить захват из чата", on_vipchat) then
                    jsonsettings.vrchat.on = on_vipchat[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                imgui.Help(u8'Если выключено, сообщения из випчата перестанут захватываться и передаваться в это окно.')
                if imgui.ToggleButton(u8 " Реклама", on_reklama) then
                    jsonsettings.vrchat.ad = on_reklama[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                imgui.Help(u8'При включении показывает сообщения, установленные игроками как \"Рекламные\".')
                imgui.SameLine()
                if imgui.ToggleButton(u8 " Стандартные", standart_vip) then
                    jsonsettings.vrchat.vip = standart_vip[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                imgui.Help(u8'При включении показывает сообщения, установленные игроками как \"Не рекламные\".')
                imgui.Text(ti.ICON_SEARCH .. u8" Поиск:")
                imgui.InputTextWithHint("", u8 "NickName | ID | Часть сообщения | Префикс", vr_findelement, 256)
                imgui.SameLine()
                ...
                imgui.PopFont()
                if imgui.BeginPopupModal(u8("Выдача мута"), false, imgui.WindowFlags.AlwaysAutoResize) then
                    ...
                    if bSettings.fastpunish.punishs.needtime then
                        imgui.CenterText(u8("Своё время"))
                    ...
                    imgui.CenterText(u8("Своя причина"))
                    ...
                    if imgui.Button(u8'Добавить/удалить время/причину мута') then
                        imgui.OpenPopup(u8("Изменение время/причины"))
                    end
                    if imgui.BeginPopupModal(u8("Изменение время/причины"), false, imgui.WindowFlags.AlwaysAutoResize) then
                        imgui.PushItemWidth(imgui.GetWindowWidth() - 30)
                            imgui.PopItemWidth()
                            imgui.Columns(2)
                            imgui.Text(u8("Время"))
                            imgui.NextColumn()
                                ...
                                if imgui.Button(u8("Закрыть"), imgui.ImVec2(150 * MONET_DPI_SCALE, 30 * MONET_DPI_SCALE)) then
                                    imgui.CloseCurrentPopup()
                                end
                                imgui.SameLine()
                                if imgui.Button(u8("Сохранить"), imgui.ImVec2(150 * MONET_DPI_SCALE, 30 * MONET_DPI_SCALE)) then
                                    save()
                                    imgui.CloseCurrentPopup()
                                end
                                imgui.EndPopup()
            ...
            if navigation.current == 2 then -- обычный
                if imgui.ToggleButton(u8 " Включить захват из чата", on_chat) then
                    jsonsettings.chat.on = on_chat[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                if imgui.ToggleButton(u8 " Обычные сообщения", on_stchat) then
                    jsonsettings.chat.ons = on_stchat[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                imgui.Help(u8'При включении показывает сообщения, отправленные в обычный чат.')
                imgui.SameLine()
                if imgui.ToggleButton(u8 " Сообщения в NRP чате", on_nrp) then
                    jsonsettings.chat.nonrp = on_nrp[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                imgui.Help(u8'При включении показывает сообщения из NRP чата.')
                imgui.SameLine()
                if imgui.ToggleButton(u8 " От Администрации", on_adminnrp) then
                    jsonsettings.chat.admin = on_adminnrp[0]
                    save()
                end
                imgui.SameLine()
                imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                imgui.Help(u8'При включении показывает сообщения, отправленные Администрацией в NRP чат.')
                imgui.Dummy(imgui.ImVec2(0, 2))
                imgui.Separator()
                imgui.Dummy(imgui.ImVec2(0, 2))
                imgui.PushFont(minifont)
            ...
            if navigation.current == 3 then -- анти-бот
                if HeaderButton(menu1 == 1, ti.ICON_SETTINGS..u8'Настройки') then
                    menu1 = 1
                end
                imgui.SameLine()
                if HeaderButton(menu1 == 2, ti.ICON_CHECKLIST..u8'Провайдеры в ЧС') then
                    menu1 = 2
                end
                imgui.Separator()
                if menu1 == 1 then
                    imgui.Columns(2, "БАТИ", false)
            ...
            imgui.NextColumn()
                    ...
                    imgui.SameLine()
                    imgui.Text(u8"Чекер ip при регистрации")
                    ...
                    imgui.SameLine()
                    imgui.Text(u8"Частичное скрытие ip")
                    ...
                    if bSettings.settings.antiip then
                        ...
                        imgui.SameLine()
                        imgui.Text(u8"Отключение скрытия ip регистраций")
                    end
                end
                if checker[0] then
                imgui.BeginChild('##logregs', imgui.ImVec2(550, 95), false)
                    ...
                    imgui.SameLine()
                    imgui.Text(u8'Лог регистраций на экране')
                    if logregim[0] then
                        if not isMonetLoader() then
                        if imgui.Button(u8"Изменить позицию чекера") then
                            bSettings.settings.logreg = true
                                checkCursor = true
                                sampSetCursorMode(4)
                                notify.game.push('Admin Helper', 'Двигайте мышкой, затем нажмите ЛКМ для сохранения позиции')
                                lua_thread.create(function()
                                while checkCursor do
                                    wait(0)
                        ...
                        notify.game.push('Admin Helper', 'Зажмите пальцем и выбирете местоположение после чего отпустите палец что-бы сохранить позицию', -1)
                        WinState[0] = false
				...
				if imgui.Button(u8'Слева', but_size) then
					font_set['align'][0] = 1
				...
				if imgui.Button(u8'По центру', but_size) then
					font_set['align'][0] = 2
					jsonsettings.settings.align = font_set['align'][0]
				end
				imgui.PopStyleVar()
				...
				if imgui.Button(u8'Справа', but_size) then
					font_set['align'][0] = 3
					jsonsettings.settings.align = font_set['align'][0]
				end
				imgui.PopStyleVar()
                ...
                if imgui.SliderInt('##pagesize', set.pagesize, 1, MAX_LOG_BUFFER, u8'Строк: %d') then
                ...
                imgui.EndChild()
                    ...
                    imgui.SameLine()
                    imgui.Text(u8"Кастомные варнинги")
                    ...
                    imgui.SameLine()
                    imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                    imgui.Help(u8"Читать ниже функцию")
                        imgui.PushItemWidth(150)
                        imgui.InputText(u8"", tagim, 256)
                        imgui.SameLine()
                    imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                    imgui.Help(u8"Для баноффа эта функция ищет строчку с вашим баном и преобразовывает её в /banoff 0 ник забаненого 2000 чит // тег, оно будет сохранять по пути moon/monetloader - config - !banoff.txt, даже если было выдано по форме(опять таки нужно ввести сюда тег)\nДля абота - если у вас нету аццепта то оно будет отправлять форму на бан с тегом, указаным тут")
                        imgui.PopItemWidth()
                        jsonsettings.settings.tag = u8:decode(str(tagim))
                        save()
                    imgui.Text(u8'Abot скрипта')
                    imgui.SameLine()
                    imgui.TextDisabled("("..ti.ICON_QUESTION_MARK..")")
                    imgui.Help(u8"Чем различается от abot'a arztools'a?\nОкошко с провайдером, айпи, город и страны игрока\nДополнительные кнопочки которые помогут с баном итд\nБолее удобная менюшка чем у арз тулса\nАктивация - /abots")
                    imgui.Dummy(imgui.ImVec2(0, 2))
                    imgui.Separator()
                    imgui.Dummy(imgui.ImVec2(0, 2))
                    end
                ...
                imgui.SameLine()
                imgui.Text(u8"Добавление провайдера(не забывайте на начале AS и номер)")
                imgui.SameLine()
                imgui.PushFont(minifont)
                imgui.TextColoredRGB(u8'{ffffff}Также есть команды:{FFff00}/addbot [id] /add.bot [ip]')
                imgui.PopFont()
                imgui.Text(yspex)
                if abotcfg then
                    imgui.SameLine()
                ...
                imgui.Separator()
                    for k, v in pairs(jsonsettings.bots) do
                        ...
                        if imgui.Button(u8"X##"..k, imgui.ImVec2(25, 25)) then
                            ...
                            save()
                            yspex = (u8("log: Провайдер "..v.." удалён!"))
                        end
                end
            end
        end
            if navigation.current == 4 then -- формы
                if imgui.SliderInt(u8' Уровень админки', bSettings.adminLvl, 1, 4) then jsonsettings['forms']['adminLvl'] = bSettings.adminLvl[0] save() end
        if imgui.Button(u8"АвтоНастройка под вашу админку") then
        ...
        if imgui.SliderInt(u8'Время принятия формы', bSettings.forms.timeform, 5, 30) then jsonsettings['forms']['timeform'] = bSettings.forms.timeform[0] save() end
        imgui.PopItemWidth()
        ...
        imgui.Text(u8"Форма")
        imgui.NextColumn()
        imgui.Text(u8"Ничего не делать")
        imgui.NextColumn()
        imgui.Text(u8"Принимать форму")
        imgui.Separator()
        imgui.NextColumn()
        for form, v in pairs(accessesForms) do
            imgui.Text("/"..form)
        ...
        imgui.Columns()
            ...
            if navigation.current == 5 then -- описания
                if imgui.Button(isChecking and u8'Остановить проверку '..ti.ICON_POWER or u8'Запустить проверку '..ti.ICON_POWER) then
                    if isChecking then
                        stopCheck = true
                    else
                        isChecking = true
                ...
                imgui.SameLine()
                imgui.CenterText(isChecking and u8'Проверка - {18ff03}запущена' or u8'Проверка - {ff0303}остановлена')
                imgui.CenterText(u8'')
                imgui.Separator()
                imgui.NextColumn()
                imgui.Columns(2, "АФК описания", true)
                imgui.SetColumnWidth(-1, 180); imgui.CColumn(u8"Ник")
                imgui.NextColumn()
                imgui.SetColumnWidth(-1, 920); imgui.CColumn(u8"Описание персонажа, взаимодействия")
                imgui.Separator()
                imgui.NextColumn()
                for id, data in pairs(playerData) do
                    ...
                    imgui.NextColumn()
                    if imgui.Button(u8(data.opistext), imgui.ImVec2(740,30)) then
                        sampSendChat('/checkdesc '..data.nick)
                    end
                    imgui.SameLine()
                    if imgui.Button(ti.ICON_TRASH.. u8"", imgui.ImVec2(50,30)) then
                        sampSendChat("/adeldesc " .. data.nick .. " 24 НРП Описание")
                    end
                    imgui.NextColumn()
                    imgui.Separator()
                end
              end
            if navigation.current == 6 then -- лист
                imgui.TextColoredRGB(u8'{22fc00}/chaks - {ffffff}проверить игроков в радиусе на аксы {22fc00}/chobv - {ffffff}на обвесы, {22fc00}работает на Mobile и PC')
                imgui.TextColoredRGB(u8'{22fc00}/chplos - {ffffff}проверить пакетлос в радиусе(варнинг если выше 10{22fc00}работает на Mobile и PC')
                imgui.PushFont(sfont)
                imgui.Text(u8'Only PC не будет работать на мобайле!!(то что ниже)')
                imgui.PopFont()
                imgui.TextColoredRGB(u8'{22fc00}/plcheck - {ffffff}проверить сколько и из какой организации игроки')
                if imgui.ToggleButton(u8"MO", armi) then
                    jsonsettings.settings.armi = armi[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"МЮ", minust) then
                    jsonsettings.settings.minust = minust[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"РМ", rusmaf) then
                    jsonsettings.settings.rusmaf = rusmaf[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Якудза", yakuz) then
                    jsonsettings.settings.yakuz = yakuz[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"ЛКН", lacon) then
                    jsonsettings.settings.lacon = lacon[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"ВМС", warloc) then
                    jsonsettings.settings.warloc = warloc[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Маски", mask) then
                    jsonsettings.settings.mask = mask[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Игроки", play) then
                    jsonsettings.settings.play = play[0]
                    save()
                end
                if imgui.ToggleButton(u8"Вагос", vagos) then
                    jsonsettings.settings.vagos = vagos[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Балас", balas) then
                    jsonsettings.settings.balas = balas[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Грув", grove) then
                    jsonsettings.settings.grove = grove[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Рифа", rifa) then
                    jsonsettings.settings.rifa = rifa[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Ацтек", aztec) then
                    jsonsettings.settings.aztec = aztec[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"Волки", wolfs) then
                    jsonsettings.settings.wolfs = wolfs[0]
                    save()
                end
                imgui.SameLine()
                if imgui.ToggleButton(u8"ТРБ", trb) then
                    jsonsettings.settings.trb = trb[0]
                    save()
                end
                if not isMonetLoader() then
                if imgui.Button(u8"Изменить положение чекера") then
                    delay35()
                end
                end
            end
            if navigation.current == 7 then -- о скрипте
              if menu5 == 1 then
            if HeaderButton(menu5 == 1, ti.ICON_CHECKLIST..u8"О скрипте") then
                menu5 = 1
            end
            imgui.SameLine()
            if HeaderButton(menu5 == 2, ti.ICON_CHECKLIST..u8"Изменение функционала, интерфейса") then
                menu5 = 2
            end
                if imgui.Button(u8'ДС разраба', imgui.ImVec2(120, 30)) then
                    openLink('https://www.discord.com/makson4ck')
                end
                imgui.SameLine()
                if imgui.Button(u8'Тема на blasthack', imgui.ImVec2(120, 30)) then
                    sampAddChatMessage('in rezerv', -1)
                end
                imgui.CenterText(u8"Текущая версия скрипта "..bSettings.update.version)
                if bSettings.update.needupdate then
                    imgui.SetCursorPosX((imgui.GetWindowWidth() - imgui.CalcTextSize(u8"Обновиться").x) / 2)
                    if imgui.Button(u8"Обновиться") then
                        delay34()
                        end
                else
                    imgui.SetCursorPosX((imgui.GetWindowWidth() - imgui.CalcTextSize(u8"Проверить обновление").x) / 2)
                    if imgui.Button(u8"Проверить скрипт на наличие обновлений") then
                        delay32()
                    end
              end
                if bSettings.update.needupdate then
                ...
                imgui.PushFont(minifont)
                imgui.CenterText(u8'Всех приветствую пользователи моего админ хелпера')
                imgui.Text(u8'Скрипт создан исключительно в админских целях, также хочу сразу сказать, вкладка анти-бот, PlayerList была создана при помощи пользователя ADust')
                imgui.Text(u8'Все остальные функции были созданы исключительно мною\nТакже есть две вкладки это PlayerList и Кастом формы, кастом формы более идут как для мобайла, а PlayerList если вы хотите проверять игроков в радиусе только ПК')
                imgui.Text(u8'Чтобы замутить человека в обычном чате/вип чате который выводится в окно - нажмите на ник, выберите причину и время, после чего выдавайте мут(также можно ввести свою причину и время ниже вставив туда его)')
                imgui.PopFont()
                imgui.PushFont(sfont)
                imgui.Text(u8'Закрытый код, защита от декомпиляторов, проверка на админа.')
                imgui.PopFont()
                imgui.PushFont(minifont)
                imgui.Text(u8'Закрытый код тулса потому-что не хочу чтобы код кто-то своровал, авторство онли пользователя makson4ck Pauza(blasthack)')
                imgui.Text(u8'Код также не подходит ни к одному декомпилятору, не пытайтесь даже его декомпилировать')
                imgui.TextColoredRGB(u8'{3cff00}В скрипте есть защита от игрока, игроку пользоватся им не даст, какая именно защита - не расскажу.')
                imgui.PopFont()
        elseif menu5 == 2 then
            if HeaderButton(menu5 == 1, ti.ICON_CHECKLIST..u8"О скрипте") then
                menu5 = 1
            ...
            imgui.SameLine()
            if HeaderButton(menu5 == 2, ti.ICON_CHECKLIST..u8"Изменение, интерфейса") then
                menu5 = 2
            end
            delay36()
            imgui.SameLine()
            imgui.Text(u8' - Прозрачность скрипта(работает онли на стандарт теме')
            end
        end
            imgui.EndChild()
        end
...
notify.game.frame = imgui.OnFrame(
	...
	function(self)
		...
		if (os.clock() - notify.game.timer) >= notify.game.min_duration and last_activity() < 30 then
			notify.game.timer = os.clock()
		...
		imgui.Begin("##NotifyWindow", nil, imgui.WindowFlags.NoMove + imgui.WindowFlags.NoDecoration + imgui.WindowFlags.NoInputs)
			...
			imgui.SetCursorPos(imgui.ImVec2(w_size.x - 75, -30 + (20 * notify.game.anim_value)))
			local alpha = 0.1 + math.abs(math.sin(os.clock()) * 0.5)
			imgui.Image(IMG_AT, imgui.ImVec2(64, 64), nil, nil, imgui.ImVec4(1.0, 1.0, 1.0, alpha))
...
imgui.OnFrame(function() return leader_frame[0] end, function(player)
        ...
        imgui.Text(u8'ID лидера')
        imgui.SameLine()
        imgui.InputText('##addid', idpost, 256)
        imgui.Text(u8'Название фракции')
        imgui.SameLine()
        imgui.InputText('##addfrac', namefrac, 256)
        if imgui.Button(u8'/ao поставлен') then
            sampSendChat('/ao Поставлен лидер фракции "'..u8:decode(str(namefrac))..'" - '..sampGetPlayerNickname(idpost[0])..' желаем успешного срока!')
            sampSendChat('/time')
        end
        imgui.SameLine(50)
        if imgui.Button(u8'/ao снят') then
            sampSendChat('/ao Снят лидер фракции "'..u8:decode(str(namefrac))..'" - '..sampGetPlayerNickname(idpost[0])..' желаем удачи!')
            sampSendChat('/time')
        end
...
function chupd()
    ...
    local versionInfo = cjson.decode(response.text)
    if versionInfo['version'] ~= bSettings.update.version then
        sampAddChatMessage('{4682B4}[Admin Helper]{00ff11} Найдено обновление! {ffffff}Чтобы обновится введите {4682B4}/helper{ffffff} - вкладка о скрипте')
        sampAddChatMessage('{4682B4}[Admin Helper]{ffffff} и нажать проверить обновления потом на кнопку обновить!', -1)
    else --nothing
    end
end
end
...
function formatTime(seconds)
    ...
    if hours > 0 then
        formattedTime = formattedTime .. hours .. " час "
    end
    if remainingMinutes > 0 then
        formattedTime = formattedTime .. remainingMinutes .. " минут "
    end
    if remainingSeconds > 0 or formattedTime == "" then
        formattedTime = formattedTime .. remainingSeconds .. " сек "
    end
    formattedTime = formattedTime .. "назад"
...
function checklvl(arg)
	...
	if status then
		...
		status = false
		pl = {}
		notify.game.push('Admin Helper', 'Проверка ботов остановлена')
		return
	end
	pl = {}
	if arg ~= "" and arg:find("^%d+$") then
		lua_thread.create(function ()
			...
			if #tablelvls == 0 then
				notify.game.push('Admin Helper', 'Аккаунты с указанным лвл не найдены. Попробуйте повторить попытку возможно не обновился TAB')
            else
                sampAddChatMessage('{4682B4}[Admin Helper] {FFFFFF}Проверка ботов успешно {3CFF00} начата', -1)
			end
			listlvl = tablelvls
			lvl = arg
			abot[0] = true
				...
				while not key do
					...
					if keyback then
						...
						if tablelvls[k - 1] then
							...
							sampAddChatMessage("Используй NEXT", 13458524)
						end
					end
				end
				key = false
		...
		sampAddChatMessage("Используй /abots [lvl]", 13458524)
	end
end
imgui.OnFrame(function()
    return abot[0]
		...
		imgui.Begin(u8("ANTI BOT##rывавыаааа"), abot, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoBringToFrontOnFocus + imgui.WindowFlags.NoSavedSettings + imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoScrollbar)
		if listlvl then
			imgui.CenterText(u8("По запросу " .. lvl .. " LVL " .. #listlvl .. " аккаунтов."))
			imgui.Separator()
			if not id then
				id = "-1"
				name = "-1"
			...
			imgui.TextColoredRGB2(("Айпи: %s\nГород: %s"):format(ips,gor))
			imgui.EndChild()
			imgui.SameLine()
			imgui.BeginChild('##twoip', imgui.ImVec2(350, 74), true)
			imgui.TextColoredRGB2(("Страна: %s\nПровайдер: %s"):format(strana,provaid))
			imgui.EndChild()
			...
			if imgui.Button("OFF", imgui.ImVec2(112, 30)) and status then
				...
				pl = {}
      sampSendChat("/reoff")
				sampAddChatMessage("[Abot] {FFFFFF}Проверка ботов {FF0000}остановлена", 13458524)
			end
			imgui.SameLine()
			if imgui.Button(u8"Резапрос", imgui.ImVec2(112, 30)) then
			...
			if imgui.Button("Next", imgui.ImVec2(112, 30)) then
     		...
     		imgui.SameLine()
			 if imgui.Button(u8"В ЧС Провайд", imgui.ImVec2(112, 30)) then
				addbot(ipb)
			end
			if imgui.Button("/sbanip", imgui.ImVec2(112, 30)) then
                ...
                sampSendChat("/a /sbanip "..name.." чит // "..tag)
                end
			end
			imgui.SameLine()
     ...
     if imgui.Button("/ban 30", imgui.ImVec2(112,30)) then
      ...
      sampSendChat("/ban "..id.." 30 чит")
            ...
            sampSendChat("/a /ban "..id.." 30 чит // "..tag)
     end
    end
	 imgui.SameLine()
	...
	elseif name == "error" then
			imgui.Text(u8("По запросу * LVL * аккаунтов."))
...
function adbot(id)
	if id == "" then
	sampAddChatMessage('Введите /addbot [id]', -1)
	else
	lua_thread.create(function()
	adbotcfg = true
	sampSendChat("/pgetip "..id)
	...
	if ip and ip:find("(%d+%.%d+%.%d+%.%d+)") then
		asyncHttpRequest('GET', "http://ip-api.com/json/"..ip.."?fields=status,country,city,as,query&lang=ru", nil,
         ...
         function(err)
			...
			sampAddChatMessage('Введите /add.bot [ip]', -1)
	end
end
...
function chipbot(str)
	local nick, id, ip = str:match("Приветствуем нового игрока нашего сервера%: %{......%}(.+) %{FFFFFF%}%(ID%: (%d+)%)  %{......%}IP%: (.+)") 
	local check = true
	asyncHttpRequest('GET', "http://ip-api.com/json/"..ip.."?fields=status,country,city,as,query&lang=ru", nil --[[Аргументы запроса]],
         function(response)
			...
			if check then
				sampAddChatMessage("[AntiBot]{ffffff} "..nick.."["..id.."] ip: "..ip.." провайдер: "..rdata["country"] .. " - "..prov, 0x4169E1)
         ...
         function(err)
			...
			sampAddChatMessage("[AntiBot]{ffffff} "..nick.."["..id.."] провайдер: ERROR", 0x4169E1)
...
imgui.OnFrame(function() return bSettings.forms.activeform[0] end,
    function(player)
        ...
        if bSettings.forms.spec then
            imgui.Text(u8"Отправитель формы: "..str(bSettings.forms.formnick))
            imgui.Separator()
            imgui.TextColoredRGB(bSettings.forms.formplus and u8"Подтвеpждение на форму:{00fc11} присутствует." or u8"Подтвеpждение на форму: {fc0303} отсутствует/еще не найдено")
            imgui.Separator()
            imgui.Text(u8(str(bSettings.forms.formtext)))
            imgui.Separator()if imgui.Button(u8'Принять##form', imgui.ImVec2(175, 40)) then bSettings.forms.isKeyAccept[0] = true 
               end
            imgui.SameLine()
            if imgui.Button(u8"Отклонить##specForm", imgui.ImVec2(175, 40)) then bSettings.forms.isKeyDisband[0] = true
              end
        else
            imgui.Text(u8("Отправитель формы: "..str(bSettings.forms.formnick)))
            imgui.Separator()
            ...
            imgui.Text(u8(str(bSettings.forms.formtext)))
            imgui.Separator()
            imgui.Text(u8"Времени чтобы принять форму осталось: "..bSettings.forms.count_time[0])
            imgui.Separator()
            if imgui.Button(u8'Принять##form', imgui.ImVec2(175, 40)) then bSettings.forms.isKeyAccept[0] = true
            bSettings.forms.activeform[0] = false end
            imgui.SameLine()
            if imgui.Button(u8"Отклонить##form", imgui.ImVec2(175, 40)) then bSettings.forms.isKeyDisband[0] = true 
            bSettings.forms.activeform[0] = false end
            if bSettings.forms.specPlayer ~= nil then
                if imgui.Button(u8"Следить за формой##form", imgui.ImVec2(imgui.GetWindowWidth() - 15, 30 * MONET_DPI_SCALE)) then
                    if sampIsPlayerConnected(bSettings.forms.specPlayer) then
                        ...
                        sampSendChat("/a [Forma] @"..str(bSettings.forms.formnick).." Игрок не в сети")
        ...
        lua_thread.create(function ()
            ...
            while count_time < bSettings.forms.timeform[0] and bSettings.forms.activeform[0] do
                ...
                if bSettings.forms.isKeyDisband[0] then
                    ...
                    bSettings.forms.activeform[0] = false
                    sampSendChat("/a [Forma] +")
                    sampSendChat("/a [Forma] @"..nick.." форма отклонена")
                end

                if bSettings.forms.isKeyQuestion[0] then
                    sampSendChat("/a [Forma] @"..nick.." Подтверди выдачу наказания "..sampGetPlayerNickname(bSettings.forms.specPlayer))
            ...
            if responseResult.reg ~= nil and #responseResult.reg >= 0 and responseResult.last ~= nil and #responseResult.last >= 0 then
                if bSettings.ip.sendAChatIp[0] then
                    if bSettings.ip.ipData['reg_steal'] == bSettings.ip.ipData['last_steal'] then
                        sampSendChat("/a Различия в ip игрока "..str(bSettings.forms.formnick).." не найдены")
                    else
                            sampSendChat("/a @"..str(bSettings.forms.formnick).." Рег IP и Текущий ip игрока "..bSettings.ip.ipData['nick_steal'].." различаются")
                            sampSendChat(string.format("/a @%s Различаются: %s %s %s", str(bSettings.forms.formnick), (responseResult['reg']['provider'] == responseResult['last']['provider'] and "Провайдер " or ""), (responseResult['reg']['city'] == responseResult['last']['city'] and "Город " or ""), (responseResult['reg']['country'] == responseResult['last']['country'] and "Страна" or "")))
                            sampSendChat(string.format("/a @%s Приблизительное расстояние между IP: %s км", str(bSettings.forms.formnick), responseResult['distance']))
                    end
...
function onScriptTerminate(script, game_quit)
    if script == thisScript() and not game_quit and not reload_script then
		sampAddChatMessage('[Admin Helper] {ffffff}Произошла неизвестная ошибка, хелпер приостановил свою работу!', 0x4169E1)
		if not isMonetLoader() then 
            thisScript():reload()
            sampAddChatMessage('[Admin Helper] {ffffff}Пытаюсь перезагрузить скрипт, если не получится тогда..', 0x4169E1)
			sampAddChatMessage('[Admin Helper] {ffffff}Используйте CTRL + R чтобы перезапустить хелпер.', 0x4169E1)
		end
        if isMonetLoader() then
            thisScript():reload()
            sampAddChatMessage('[Admin Helper] {ffffff}Пытаюсь перезагрузить скрипт, если не получится тогда..', 0x4169E1)
            sampAddChatMessage('[Admin Helper] {ffffff}Если у вас есть скрипт менеджер то проведите по карте справа налево зайдите во вкладку Last Crashers и нажмите reload около названия хелпера!', 0x4169E1)
            sampAddChatMessage('[Admin Helper] {ffffff}В ином случаи перезайдите в игру.', 0x4169E1)
        end
    end
end
        ...
        while true do
            ...
            for k, v in ipairs(getAllChars()) do                local res, id = sampGetPlayerIdByCharHandle(v)
                local colorid = sampGetPlayerColor(id)                    if colorid == 2157536819 then -- MO
                        ...
                        maska = maska + 1                    --elseif colorid == 16777215 then -- ты - 16777215
                        --adm = adm + 1                    end
                end
            end
            end
...
function aks()
	...
	sampAddChatMessage("{4682B4}[PList]{ffffff} Начата проверка игроков на аксы. Фикс - /plfix", -1) 
		players = getAllChars()
		...
		wait(2000)
	sampAddChatMessage("{4682B4}[PList]{ffffff} Проверка окончена. Найдено "..caks.." нарушителей.", -1) 
	check = false
	end)
end
function obv()
	...
	cobv = 0
	table.remove(players)
	sampAddChatMessage("{4682B4}[PList]{ffffff} Начата проверка игроков на обвесы. Фикс - /plfix", -1)
		players = getAllChars()
		for k,v in pairs(players) do
			local res, id = sampGetPlayerIdByCharHandle(v)
			if res then
		...
		wait(2000)
	sampAddChatMessage("{4682B4}[PList]{ffffff} Проверка окончена. Найдено "..cobv.." нарушителей.", -1)
	check = false
end)
end
function plos()
    ...
    lua_thread.create(function()
    table.remove(players)
	sampAddChatMessage("{4682B4}[PList]{ffffff} Начата проверка игроков на packetlos. Фикс - /plfix", -1)
    players = getAllChars()
    for k,v in pairs(players) do
        local res, id = sampGetPlayerIdByCharHandle(v)
        if res then
    ...
    wait(2000)
sampAddChatMessage("{4682B4}[PList]{ffffff} Проверка окончена. Найдено "..cplos.." нарушителей.", -1)
check = false
end)
end
